...
import { Home, PhoneCall, MapPin, Mail, FileSpreadsheet, ShieldCheck, Heart } from 'lucide-react';
    ...
    <footer className="bg-slate-950 text-slate-300 pt-12 pb-8 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <div className="space-y-2.5 text-xs">
              ...
              <div className="p-3 bg-slate-900 rounded-xl border border-slate-800">
                ...
                <a href={`mailto:${bookingEmail}`} className="text-xs font-extrabold text-emerald-400 hover:underline flex items-center gap-1.5 mt-0.5 truncate">
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-2">
          <span><a href="#admin" className="hover:text-slate-400 transition-colors cursor-pointer font-bold text-slate-400">© 2026 San Sài gòn</a> — Hệ thống đăng tin phòng trọ, KTX, phòng pass Sài Gòn.</span>
