...
import { Phone, MessageCircle, X, CheckCircle2, Copy, Sparkles, ShieldCheck, ChevronUp } from 'lucide-react';
...
export const FloatingContactWidget: React.FC<FloatingContactWidgetProps> = ({
  ...
  const displayPhone = bookingPhone;
  const phone = bookingPhone.replace(/\s+/g, '');
